...
$title = '選曲補助（β）';
$h2 = "選曲補助リスト(β)";
//responsible css of this page
$aditionalcss = '<link rel="stylesheet" href="table-grid-resp.css?b2e5aa2h">';
...
<div id="tableoutline">
    ...
    //
    //
    putHtmlH3("２回以上歌われて、最近半年以上歌われていない曲・直近古い順（LL除外）");
    ?>
    <!--
    ...
    $having = 'having count(*)>1 and max(evdate)<"' . date('Y/m/d', strtotime('-6 month')) . '"';
    $mode = '';
